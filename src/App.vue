      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16  relative flex items-center justify-between">
        <router-link to="/" class="flex items-center gap-2 group">
          <div class="w-8 h-8 flex items-center justify-center transition-transform scale-200">
            <img src="/logo.png" alt="OsonQR Logo" class="h-full w-auto" />
          </div>
          <span
            class="text-xl font-bold bg-clip-text z-10 text-transparent bg-gradient-to-r from-brand-600 to-brand-900">OsonQR</span>
        </router-link>
