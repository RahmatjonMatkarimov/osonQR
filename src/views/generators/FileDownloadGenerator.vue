<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Fayl tizimga Ochiq URL havola (Masalan Google
                Drive, DropBox)</label>
            <input type="url" v-model="url" placeholder="https://example.com/archive.zip"
        ...
        <div class="text-xs text-brand-600 bg-brand-50 p-3 rounded-lg flex items-start">
            ...
            <p>Turli xil (mp3, zip, exc, docx) fayllarni avval internetga yuklagach ularning ommaviy yuklab olinuvchi
                ssilkasini bering.</p>
        </div>
    </div>
</template>
