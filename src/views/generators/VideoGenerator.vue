<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Video manbasi / URL fayl</label>
            <input type="url" v-model="url" placeholder="https://example.com/video.mp4"
        ...
        <div class="text-xs text-brand-600 bg-brand-50 p-3 rounded-lg flex items-start">
            ...
            <p>Youtube kabi saytlardan ochiq videoga havola nusxalab yoki Google Drive kabiga yuklgan ochiq video
                linkini bering.</p>
        </div>
    </div>
</template>
