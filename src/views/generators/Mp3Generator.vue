<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">MP3 File URL</label>
            <input type="url" v-model="url" placeholder="https://example.com/audio.mp3"
