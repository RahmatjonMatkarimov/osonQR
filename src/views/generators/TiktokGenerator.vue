<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">TikTok Profil URL / Username</label>
            <input type="url" v-model="url" placeholder="https://tiktok.com/@osonqr"
...
const updateQr = () => {
    ...
    qrState.data = finalUrl || 'https://tiktok.com/'
}
