<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">YouTube Kanal / Video URL</label>
            <input type="url" v-model="url" placeholder="https://youtube.com/@osonqr"
...
const updateQr = () => {
    ...
    qrState.data = finalUrl || 'https://youtube.com/'
}
