<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">PDF fayl URL manzili</label>
            <input type="url" v-model="url" placeholder="https://example.com/hujjat.pdf"
        ...
        <div class="text-xs text-brand-600 bg-brand-50 p-3 rounded-lg flex items-start">
            ...
            <p>Siz o'z PDF faylingizni Google Drive, Dropbox yoxud veb-saytingizga yuklab, o'sha ochiq havolani bu yerga
                joylashingiz so'raladi.</p>
        </div>
    </div>
</template>
