<template>
    <div class="space-y-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Facebook Profil / Sahifa URL</label>
            <input type="url" v-model="url" placeholder="https://facebook.com/khasmatkarimov"
...
const updateQr = () => {
    ...
    qrState.data = finalUrl || 'https://facebook.com/'
}
